...
\textit{caching}~\cite{Herodotou2019AutoCache,
  Sethumurugan2021Designing, Sun2022NCache, Shuja2021Applying,
Wang2018Efficient, Berger2018Towards}. Penelitian ini secara
spesifik menyelidiki bagaimana \textit{machine learning} dapat
diimplementasikan dalam sistem \textit{cache} untuk meningkatkan
efisiensi algoritma populer seperti CLOCK terhadap distribusi
zipfian~\cite{Breslau1999Web}.
...
terbatas pada prosesor
\textit{single-core}~\cite{Liptay1968Structural, Turing2004Lecture,
Shima2005The, Bäck1997Evolutionary}. Keterbatasan ini memaksa
para insinyur dan pemrogram untuk merancang perangkat lunak yang
dioptimalkan untuk eksekusi
\textit{single-threaded}. Seiring waktu,
ketika peningkatan kinerja mulai melambat karena batasan fisik dan
termal, industri beralih ke arsitektur
\textit{multi-core}~\cite{Papadopoulos1991Multithreading,
Herlihy2006The, Borkenhagen2000A, Abdallah2017Advanced} dan
paralel~\cite{Sodan2010Parallelism, Kim2016Performance,
Eickemeyer1996Evaluation}. Transisi ini memperkenalkan tantangan baru
dalam desain
...
penyimpanan yang lebih cepat~\cite{Belady1966A, Wilkes1965Slave,
Liptay1968Structural}. Selama bertahun-tahun, berbagai
...
\textit{cloud}~\cite{Zhang2012A, Liu2022Adaptive, Zhang2016HDCache}.
...
yang ada~\cite{Eklöv2011Fast, Calandrino2009On, Seo2009Design}. Dalam
lingkungan seperti ini, beberapa inti prosesor sering
...
conditions}) dan inkonsistensi data~\cite{Herlihy2006The}. Untuk
...
dan modifikasi~\cite{Vera2003Data, Hu1998A, Mohan2005Efficient}.
Namun, penggunaan \textit{lock} yang berlebihan dapat
...
rendah dengan mempertahankan data yang sering
diakses~\cite{Fricker2012A, O’Neil1993The, O’Neil1999An}. Namun, LRU
...
lebih rendah, karena hampir tidak memerlukan
\textit{locking}~\cite{Dan1990An, Moir2005Using, Molnar2002A}.
...
skalabilitas tinggi   te{Tang1976Cache}. CLOCK menggunakan
\textit{buffer} melingkar
...
skalabilitas serta kesederhanaan yang menjadi ciri khas
FIFO~\cite{chen2025lazy}.

Namun, terlepas dari keunggulannya, algoritma CLOCK masih mengalami
masalah promosi yang tidak
perlu~\cite{Eads2014NbQCLOCK,chen2025lazy}. Karena setiap akses akan mengatur
...
beradaptasi secara dinamis terhadap karakteristik beban kerja yang
berubah~\cite{Cunningham2008Supervised,Chapelle2006SemiSupervised,Hilbe2009Logistic,Hosmer2013Applied}.
...
keras. Studi ini mengevaluasi metrik kinerja seperti \textit{miss
...
\textit{caching} berbasis \textit{reinforcement
learning}~\cite{Sutton2005Reinforcement} yang
...
menekankan performa asli pada perangkat keras nyata. Penelitian ini
juga terbatas pada \textit{datasets} berbasis zipfian.
